...
return [
    ...
    'auth' => [
         ...
         */
        'use_value' => env('SCRIBE_AUTH_KEY', 'HA UMA KEY DEFAULT'),
     ...
     */
    'intro_text' => <<<INTRO
API descritiva de todos os endpoints bem como a sua forma de utilização.

<aside>Navegate on the sideBar to get all the documentation</aside>
INTRO
    ,
